...
{% include figure.liquid path="assets/img/ai-phishing/rfc_results.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid path="assets/img/ai-phishing/cnn_results.png" class="img-fluid rounded z-depth-1" zoomable=true %}
